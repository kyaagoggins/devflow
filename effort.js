document.addEventListener('DOMContentLoaded', function() {
  ...
  const dailyTasks = [
    { task: "Color choice or possibly some other task", team: "UI/UX", progress: 35, budgeted: 5, actual: 3 },
    { task: "Choose library", team: "Frontend JS", progress: 35, budgeted: 5, actual: 4 },
    { task: "Project Setup and development environment fancy words...", team: "Backend", progress: 35, budgeted: 5, actual: 2 }
  ];

  const weeklyTasks = [
    { task: "Color choice or possibly some other task", team: "UI/UX", budgeted: 5, actual: 3 },
    { task: "Choose library", team: "Frontend JS", budgeted: 5, actual: 4 },
    { task: "Project Setup and development environment fancy words...", team: "Backend", budgeted: 5, actual: 2 }
  ];
